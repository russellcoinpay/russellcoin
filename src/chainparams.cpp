...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("39.97.224.49", "39.97.224.49"));
        vSeeds.push_back(CDNSSeedData("161.117.199.234", "161.117.199.234"));
        //vSeeds.push_back(CDNSSeedData("39.106.26.60", "39.106.26.60"));
